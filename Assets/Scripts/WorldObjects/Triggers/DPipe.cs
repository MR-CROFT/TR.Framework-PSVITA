...
public class DPipe : MonoBehaviour
{
    ...
    private void OnDrawGizmos()
    {
        ...
        // Definir cor do Gizmo
        Gizmos.color = Color.red;

        // Obter a posição do Gizmo considerando o centro do Collider
        Vector3 colliderCenter = transform.position + solidCollider.center;
        Vector3 colliderSize = solidCollider.size;

        // Desenhar a caixa representando o Collider sólido
        Gizmos.DrawWireCube(colliderCenter, colliderSize);
    }

    // Se desejar ver o Gizmo também no modo de jogo, use OnDrawGizmosSelected
